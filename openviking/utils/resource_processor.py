...
from openviking.wiki.document_manifest import write_document_manifest
                ...
                try:
                    ...
                    if not target_preexisting:
                        ...
                        await write_document_manifest(
                            ...
                            drafts=parse_result.wiki_document_drafts,
                            ctx=ctx,
                            source_format=parse_result.source_format,
                            lock_handle=resource_lock.handle if resource_lock.active else None,
                        )
